<!-- BaserPageTagBegin -->
<?php $this->BcBaser->setTitle('4. テーマカラーを設定する') ?>
...
<p>ヘッダとフッタの色は白に変更できますが、管理画面内ではできません。手順は「カスタマイズ」のページをごらんください。</p>

<p class="text-center"><a class="btn btn-lg btn-primary" href="../customize/customize02">ヘッダ・フッタを白にする</a></p>